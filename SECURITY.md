...
Security fixes target the latest version published on [npm](https://www.npmjs.com/package/opencode-provider-poolside). Update before reporting an issue that may already be fixed.
