...
Thanks for helping improve the Poolside provider for OpenCode.

## Before opening work

- Use [Discussions](https://github.com/grikomsn/opencode-provider-poolside/discussions/categories/q-a) for setup and usage questions.
